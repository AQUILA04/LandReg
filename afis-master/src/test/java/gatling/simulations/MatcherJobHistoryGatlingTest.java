        ...
        .on(
            exec(
                http("Get all matcherJobHistories")
                    .get("/services/afismaster/api/matcher-job-histories")
                ...
                .exec(
                    http("Create new matcherJobHistory")
                        .post("/services/afismaster/api/matcher-job-histories")
                        .headers(headersHttpAuthenticated)
                        .body(
                            StringBody(
                                "{" +
                ...
                .on(
                    exec(
                        http("Get created matcherJobHistory")
                            .get("/services/afismaster${new_matcherJobHistory_url}")
                            .headers(headersHttpAuthenticated)
                    ).pause(10)
                )
                .exec(
                    http("Delete created matcherJobHistory")
                        .delete("/services/afismaster${new_matcherJobHistory_url}")
                        .headers(headersHttpAuthenticated)
                )
                .pause(10)
        );
