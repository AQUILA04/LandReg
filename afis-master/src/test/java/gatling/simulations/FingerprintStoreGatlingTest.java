        ...
        .on(
            exec(
                http("Get all fingerprintStores")
                    .get("/services/afismaster/api/fingerprint-stores")
                ...
                .exec(
                    http("Create new fingerprintStore")
                        .post("/services/afismaster/api/fingerprint-stores")
                        .headers(headersHttpAuthenticated)
                        .body(
                            StringBody(
                                "{" +
                ...
                .on(
                    exec(
                        http("Get created fingerprintStore")
                            .get("/services/afismaster${new_fingerprintStore_url}")
                            .headers(headersHttpAuthenticated)
                    ).pause(10)
                )
                .exec(
                    http("Delete created fingerprintStore")
                        .delete("/services/afismaster${new_fingerprintStore_url}")
                        .headers(headersHttpAuthenticated)
                )
                .pause(10)
        );
