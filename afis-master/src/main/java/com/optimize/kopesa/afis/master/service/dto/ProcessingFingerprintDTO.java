...
/**
 * A DTO for the {@link com.optimize.kopesa.afis.master.domain.ProcessingFingerprint} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ProcessingFingerprintDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ProcessingFingerprintDTO)) {
            return false;
        }

        ProcessingFingerprintDTO processingFingerprintDTO = (ProcessingFingerprintDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, processingFingerprintDTO.id);
    }
    ...
    public String toString() {
        return "ProcessingFingerprintDTO{" +
            "id='" + getId() + "'" +
            ", rid='" + getRid() + "'" +
