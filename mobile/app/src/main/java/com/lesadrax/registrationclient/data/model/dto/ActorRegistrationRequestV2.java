...
public class ActorRegistrationRequestV2 {
    ...
    private String role;
    private String type;
    private Set<FingerprintStoreRequestV2> fingerprintStores = new LinkedHashSet<>();
    ...
    public Set<FingerprintStoreRequestV2> getFingerprintStores() {
        return fingerprintStores;
    }

    public void setFingerprintStores(Set<FingerprintStoreRequestV2> fingerprintStores) {
