  ...
  template: `
    <div class="page-container container">
      <div class="page-header">
        <h1>Registre des Constatations</h1>
...
export class FindingsList {
  ...
  columns: Column[] = [
    ...
    { key: 'personType', label: 'Type Acteur' },
    { key: 'uin', label: 'UIN' }
  ];
  ...
  constructor() {
    effect(() => {
      const filters = {
        region: this.filterStore.region(),
        prefecture: this.filterStore.prefecture(),
        commune: this.filterStore.commune(),
        canton: this.filterStore.canton(),
  ...
  loadData(currentFilters?: any) {
    ...
    this.dataService.getFindings(this.currentPage, this.pageSize, filters).subscribe({
      next: (response: any) => {
